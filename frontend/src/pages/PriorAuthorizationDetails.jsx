...
export default function PriorAuthorizationDetails() {
  ...
  // Poll results state
  // Poll results modal state removed - polling now handled via System Poll page
  ...
  const handlePreviewClaimBundle = async () => {
    try {
      ...
      const claimPreviewData = {
        ...
        eligibility_response_id: priorAuth.eligibility_response_id || null,
        eligibility_response_system: priorAuth.eligibility_response_system || null,
        eligibility_ref: priorAuth.eligibility_ref || null,
        encounter_identifier: priorAuth.encounter_identifier || null,
        vision_prescription: priorAuth.vision_prescription || null,
          ...
          {activeTab === 'clinical' && (
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {priorAuth.auth_type === 'institutional' && (priorAuth.icu_hours || priorAuth.ventilation_hours) && (
                  <>
                    <hr className="border-gray-200" />
                    <div>
                      <h4 className="font-medium mb-3 flex items-center gap-2">
                      ...
                      <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                        <div className="grid grid-cols-2 gap-4">
                          {priorAuth.icu_hours != null && priorAuth.icu_hours !== '' && (
                            <div>
                          ...
                          {priorAuth.ventilation_hours != null && priorAuth.ventilation_hours !== '' && (
                            <div>
                              <p className="text-sm text-gray-500">Ventilation Hours</p>
                              <p className="text-lg font-medium text-red-700">
                                {priorAuth.ventilation_hours} hours
                              </p>
                            </div>
                          )}
                        </div>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button 
              onClick={() => handleSubmitWithPriority(selectedPriority)}
