...
TABLE OF CONTENTS 
Abbreviations 2 
Document Release Note 3 
Section 1.0     Shadow Billing 5 
Section 2.0     Package Mapping and Billing ................................................................................................................ 6 
2.1 Current Situation ....................................................................................................... 6 
2.2 Mapping Solution....................................................................................................... 6 
2.3 Package Billing .......................................................................................................... 6 
2.3.1 Package Billing Examples: ........................................................................................ 6 
2.4 Detailed Shadow Billing Guidelines for Packages ..................................................... 7 
2.4.1 In-Patient (IP) Appendectomy Package .................................................................... 7 
2.5 Reporting in nphies ................................................................................................... 8 
2.6 Additional Package Shadow Billing Examples .......................................................... 9 
2.6.1 In-Patient (IP) Caesarean Section package and Salpingotomy ................................. 9 
2.6.2 In-Patient (IP) Partial lobectomy of brain package and Electroencephalography .... 10 
2.6.3 Out-Patient (OP) Root Canal Treatment (3 Roots) with Filling ................................ 11 
Section 3.0    Fee-For-Service Non-Standard Codes    Mapping and Billing ........................................................... 13 
3.1 Current Situation ..................................................................................................... 13 
3.2 Mapping Solution..................................................................................................... 13 
3.3 Item Billing ............................................................................................................... 13 
3.3.1 Item Billing Examples: ............................................................................................. 13 
3.4 Reporting in nphies ................................................................................................. 14 
Section 4.0     Application of Shadow Billing ............................................................................................................. 15 
4.1 Many to One Mapping of Services .......................................................................... 15 
4.2 GMDN – Medical Devices and Consumables ......................................................... 15 
4.3 GTIN – Medication .................................................................................................. 15 
4.4 Outpatient: ADA-Australian Dental Association ....................................................... 15 
4.5 Unlisted Item Codes ................................................................................................ 16 
Section 5.0    JSON Sample Messaging ...................................................................................................................... 17 
5.1 Package Sample Messaging – IP Appendectomy ................................................... 17 
5.2 Package Sample Messaging – In-Patient (IP) Caesarean Section package and 
Salpingotomy 42 
5.3 Package Sample Messaging – IP In-Patient (IP) Partial lobectomy of brain package and 
Electroencephalography 68 
5.4 Package Sample Messaging – Out-Patient (OP) Root Canal Treatment (3 Roots) with 
Filling 95 
5.5 Non-Standard Code Fee-For-Service Sample Messaging .................................... 117 
...
5.4 
5.5 
1.5 1-Jun-21 Updated instructions for GTIN - Medication 4.1 
1.6 22-Aug-21 Added a summary of Shadow billing guidelines 2.2 
1.7 11-Apr-22 Package Billing  2.3 
INTERNAL USE  
Reporting in nphies 
Item Billing 
Reporting in nphies 
...
Provider A has an In-Patient (IP) Appendectomy package with internal code Append332, with contracted price 
...
776 
552 
Procedure fees - Elective Caesarean Section package 
Drug 
Consumables 
500 
011 
...
System (SBS) 
335 
Electroencephalography Saudi Billing 
System (SBS) 
83610-01-00 
Room and Board: Per Diem - 
First Class Room 
...
003 
Root Canal Treatment Additional Canal 
Filling after Root Canal Treatment 
nphies Shadow Billing Guideline 
INTERNAL USE  
Provider A has also mapped the individual package non-standard item codes to the corresponding code from 
the nphies standard code lists 
...
INTERNAL USE  
SECTION 3.0    FEE-FOR-SERVICE NON-STANDARD CODES    
MAPPING AND BILLING 
...
Radiography of abdomen 
200 
06285097000049 AUGMENTIN 1.2GM 
VIAL 
500 
Consumables 
SFDA_GMDN / 
...
The fee-for-service reporting laid out in section 3.3 is to be implemented for mapping an item with a non
standardized code that cannot be mapped to a corresponding GMDN – Medical Devices and Consumables 
...
99999-99-91 
Procedures (SBS) 
Unlisted dental procedure code 
99999-99-92 
Dental (SBS) 
Unlisted imaging code 
73050-39-70 
Imaging (SBS) 
Unlisted chemistry tests  
73100-09-80 
Laboratory (SBS) 
...
73400-00-40 
Laboratory (SBS) 
Unlisted in vivo laboratory services  
73400-05-10 
Laboratory (SBS) 
Unlisted reproductive medicine laboratory procedure 
Laboratory (SBS) 
99999999999991 Unlisted nutritional supplements (Other nutritional 
SFDA_GTIN 
substitute) 
...
SFDA_GTIN 
SFDA_GTIN 
99999999999994 Unlisted nutritional supplements (Mother’s milk 
99999999999995 Unlisted cosmetic 
substitute (baby/infant formula) 
SFDA_GTIN 
...
99999 
SFDA_GTIN  
Unlisted medical devices 
9999 
SFDA_GMDN 
Unlisted Out-Patient Dental Code 
...
INTERNAL USE  
5.2 Package Sample Messaging – In-Patient (IP) Caesarean Section package and Salpingotomy 
{ 
 "resourceType": "Bundle", 
 "id": "5215043c-1131-4e53-8357-3b0120f22002", 
 "meta": { 
...
5.4 Package Sample Messaging – Out-Patient (OP) Root Canal Treatment (3 Roots) with Filling 
