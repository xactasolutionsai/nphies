...
class PharmacyClaimMapper extends PharmacyPAMapper {
  ...
  buildPharmacyClaimResource(claim, patient, provider, insurer, coverage, bundleResourceIds) {
    ...
    // Authorization offline date at Claim level (online priorauthresponse goes on insurance entry per BV-00462)
    ...
    // Eligibility response (online) - identifier-based reference to CoverageEligibilityResponse
