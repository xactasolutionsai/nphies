...
-- Add birth_weight column to prior_authorizations table (stored in grams, converted to kg for NPHIES)
-- Note: User enters weight in grams, system converts to kg when sending to NPHIES (BV-00509)
ALTER TABLE prior_authorizations 
...
COMMENT ON COLUMN prior_authorizations.birth_weight IS 'Birth weight in grams for newborn patients (required when is_newborn is true). Converted to kg for NPHIES per BV-00509';
