...
export const TABLE_SCHEMAS = {
  ...
  claim_batches: {
    ...
    provider_id: 'INTEGER REFERENCES providers(id) ON DELETE CASCADE',
    insurer_id: 'INTEGER REFERENCES insurers(id) ON DELETE CASCADE',
    status: 'VARCHAR(30) NOT NULL CHECK (status IN (\'Draft\', \'Pending\', \'Submitted\', \'Queued\', \'Processed\', \'Partial\', \'Rejected\', \'Error\'))',
...
export const validationSchemas = {
  ...
  claimBatch: Joi.object({
    ...
    nphies_batch_id: Joi.string().max(100).optional(),
    nphies_response_id: Joi.string().max(100).optional(),
    description: Joi.string().optional(),
    claim_ids: Joi.array().items(Joi.number().integer().positive()).optional()
  }),
