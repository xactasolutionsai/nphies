...
CREATE INDEX IF NOT EXISTS idx_patients_newborn ON patients(newborn_flag);
CREATE INDEX IF NOT EXISTS idx_patients_transfer ON patients(transfer_flag);
...
CREATE INDEX IF NOT EXISTS idx_insurers_insurer_id ON insurers(insurer_id);
...
CREATE INDEX IF NOT EXISTS idx_authorizations_auth_id ON authorizations(authorization_id);
...
CREATE INDEX IF NOT EXISTS idx_authorizations_insurer ON authorizations(insurer_id);
CREATE INDEX IF NOT EXISTS idx_authorizations_status ON authorizations(auth_status);

CREATE INDEX IF NOT EXISTS idx_eligibility_request_id ON eligibility_requests(eligibility_request_id);
CREATE INDEX IF NOT EXISTS idx_eligibility_patient ON eligibility_requests(patient_id);
CREATE INDEX IF NOT EXISTS idx_eligibility_provider ON eligibility_requests(provider_id);
CREATE INDEX IF NOT EXISTS idx_eligibility_insurer ON eligibility_requests(insurer_id);
CREATE INDEX IF NOT EXISTS idx_eligibility_status ON eligibility_requests(response_status);
...
CREATE INDEX IF NOT EXISTS idx_claim_batches_batch_id ON claim_batches(claims_batch_id);
CREATE INDEX IF NOT EXISTS idx_claim_batches_identifier ON claim_batches(batch_identifier);
CREATE INDEX IF NOT EXISTS idx_claim_batches_status ON claim_batches(status);

CREATE INDEX IF NOT EXISTS idx_payments_payment_id ON payments(payment_id);
CREATE INDEX IF NOT EXISTS idx_payments_ref_number ON payments(payment_ref_number);
...
CREATE INDEX IF NOT EXISTS idx_payments_insurer ON payments(insurer_id);
